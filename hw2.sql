CREATE TABLE IF NOT EXISTS musical_ganre (
	...
	name_of_the_ganre VARCHAR(60) NOT NULL UNIQUE
);
...
CREATE TABLE IF NOT EXISTS album (
	...
	year_of_release INT NOT NULL CHECK (year_of_release > 1980)
);

CREATE TABLE IF NOT EXISTS music_track (
	music_track_id INT PRIMARY KEY,
	track_name VARCHAR(60) NOT NULL,
	track_duration INT NOT NULL CHECK(track_duration < 500),
...
CREATE TABLE IF NOT EXISTS playlist (
	...
	year_of_playlist INT NOT NULL CHECK(year_of_playlist > 1980)
);
